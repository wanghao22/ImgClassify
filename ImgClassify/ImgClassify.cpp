...
BEGIN_MESSAGE_MAP(CImgClassifyApp, CWinApp)
...
CImgClassifyApp::CImgClassifyApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CImgClassifyApp 对象

CImgClassifyApp theApp;


// CImgClassifyApp 初始化

BOOL CImgClassifyApp::InitInstance()
{
